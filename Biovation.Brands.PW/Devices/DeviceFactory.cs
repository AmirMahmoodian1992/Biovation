...
namespace Biovation.Brands.PW.Devices
{
    public class DeviceFactory
    {
        ...
        public DeviceFactory(LogEvents logEvents, LogSubEvents logSubEvents, PwCodeMappings pwCodeMappings, BiovationConfigurationManager biovationConfigurationManager, LogService logService, DeviceBrands deviceBrands, TaskService taskService)
        {
        ...
        public Device Factory(DeviceBasicInfo device)
        {
            ...
            {
                default:
                    return new Device(device, _biovationConfigurationManager, _logEvents, _logSubEvents, _pwCodeMappings, _logService, _deviceBrands, _taskService);
            }
        }
    }
}
