...
{
	/// <summary>
	/// نوشته شده توسط suprema برای اضافه کردن متد ها و شناسایی آنها
	/// </summary>
	public class BSSDK
	{
		//
		...
		public static extern int BS_SetConnectedCallback(IntPtr proc, bool syncOp, bool autoResponse);

		[DllImport("BS_SDK.dll", CharSet = CharSet.Ansi, EntryPoint = "BS_SetDisconnectedCallback")]
		public static extern int BS_SetDisconnectedCallback(IntPtr proc, bool syncOp);
		...
		public static extern int BS_SetRequestStartedCallback(IntPtr proc, bool syncOp, bool autoResponse);
		...
		public static extern int BS_SetLogCallback(IntPtr proc, bool syncOp, bool autoResponse);
		...
		[DllImport("BS_SDK.dll",
			CharSet = CharSet.Ansi,
			EntryPoint = "BS_ReadImageLog")]
		public static extern int BS_ReadImageLog(int handle, int startTime, int endTime, ref int numOfLog, IntPtr imageData);
		...
		[DllImport("BS_SDK.dll",
			CharSet = CharSet.Ansi,
			EntryPoint = "BS_GetImageLogCount")]
		public static extern int BS_GetImageLogCount(int handle, ref int numOfLog);
		...
		*/
		...
		public const int BS_DEVICE_BIOMINI_CLIENT = 3001;
