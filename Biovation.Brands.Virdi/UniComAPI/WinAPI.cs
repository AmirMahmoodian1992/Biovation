...
namespace Biovation.Brands.Virdi.UniComAPI
{
    public static class WinAPI
    {
        ...
        public static extern uint Initialize(ref Init0 init0);

        [DllImport("UCSAPI40.dll", EntryPoint = "UCSAPI_ServerStart", CallingConvention = CallingConvention.StdCall)]
        public static extern uint UCSAPI_ServerStart(int maxTerminal, int port, int reserved, [MarshalAs(UnmanagedType.FunctionPtr)] CallbackEventHandler callbackEventFunction); //
