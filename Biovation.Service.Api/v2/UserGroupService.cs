...
namespace Biovation.Service.Api.v2
{
    public class UserGroupService
    {
        ...
        public UserGroupService(UserService userService, DeviceService deviceService, UserGroupRepository userGroupRepository,TaskService taskService, TaskTypes taskTypes, TaskPriorities taskPriorities, TaskStatuses taskStatuses, TaskItemTypes taskItemTypes, DeviceBrands deviceBrands)
        {
        ...
        public Task<ResultViewModel> ModifyUserGroupBase(string token, User creatorUser, UserGroup userGroup)
        {
        ...
        public Task<ResultViewModel> SyncUserGroupMemberBase(string listUsers,string token)
        {
            return Task.Run(() =>
            {
                try
                {
                    ...
                    var firstStep = SyncUserGroupMember(xmlObject?.OuterXml, token);
