...
namespace Biovation.Brands.Eos.Commands
{
    ...
    /// </summary>
    public class EosSyncUser : ICommand
    {
        ...
        public EosSyncUser(int userId, Dictionary<uint, Device> onlineDevices, UserService userService, AccessGroupService accessGroupService)
        {
            //todo:usercode
