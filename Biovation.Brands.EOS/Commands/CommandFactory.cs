                ...
                case CommandType.DeleteUserFromTerminal:
                    {
                        ...
                        return new EosDeleteUserFromTerminal(taskItem, _onlineDevices, _deviceService);
                    }
                ...
                case CommandType.RetrieveUserFromDevice:
                    {
                        ...
                        return new EosRetrieveUserFromDevice(taskItem, _onlineDevices, _deviceService, _userService, _userCardService, _fingerTemplateService, _faceTemplateService);
                    }
