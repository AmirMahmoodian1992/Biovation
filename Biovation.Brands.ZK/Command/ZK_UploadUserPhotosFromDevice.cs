...
{
    public class ZkUploadUserPhotosFromDevice : ICommand
    {
        /// <summary>
        ...
        public ZkUploadUserPhotosFromDevice(IReadOnlyList<object> items, Dictionary<uint, Device> devices, DeviceService deviceService)
        {
        ...
        public object Execute()
        {
            ...
            try
            {
                ...
                var result = device.UploadUserPhotos(FolderPath);
